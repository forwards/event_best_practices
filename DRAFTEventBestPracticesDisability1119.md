<h1> Event Best Practices for Disability Inclusion
...
<h2> Sensory Disabilities

Conference presentations and tutorials are made on both visual
(slides) and auditory channels: the slides and the presenter's spoken words. For people with
sensory disabilities, integrating these two channels so that all
...
While some deaf/hard-of-hearing people can use both sign language and captioning, others
